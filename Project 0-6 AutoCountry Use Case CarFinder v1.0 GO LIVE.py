...
# Handle user choice
    if choice == "1":
        print_all_vehicles()  # Print the list of authorized vehicles
    elif choice == "2":
        search_authorized_vehicle()  # Call function to search for a vehicle
    elif choice == "3":
        add_authorized_vehicle()   # Call function to add a new vehicle
    elif choice == "4":
        delete_authorized_vehicle()  # Call function to remove a vehicle
    elif choice == "5":
